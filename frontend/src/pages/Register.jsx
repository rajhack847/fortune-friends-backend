  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        <h1>Join Fortune Friends</h1>
        <p className="auth-subtitle">Friends Who Bring Fortune</p>
        
        {error && <div className="alert alert-error">{error}</div>}
        {referralCode && <div className="alert alert-success">✓ Referral code applied: {referralCode}</div>}
